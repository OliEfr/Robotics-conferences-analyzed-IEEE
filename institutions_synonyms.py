...
KIT_SYNONYMS = [
    ...
    "Karlsruhe Tech Institute",
    "Institute of Technology Karlsruhe",
    "Inst. für Technologie Karlsruhe",
    "KIT",
]
...
UTN_SYNONYMS = [
    ...
    "Technische Universität Nürnberg",
    "Technische Universitaet Nuernberg",
    "University of Technology Nuremberg",
    "Technology University Nuremberg",
    "TU Nürnberg",
    "TU Nuremberg",
    "UTN",
    "Tech. Univ. Nuremberg",
...
FRAUNHOFER_IPA_SYNONYMS = [
    ...
    "Fraunhofer Inst. for Manufacturing Engineering and Automation",
    "Fraunhofer IPA",
    "FhG IPA",
]

FRAUNHOFER_IOSB_SYNONYMS = [
    # Fraunhofer-Institut für Optronik, Systemtechnik und Bildauswertung
    "Fraunhofer-Institut für Optronik, Systemtechnik und Bildauswertung",
    "Fraunhofer-Institut fuer Optronik, Systemtechnik und Bildauswertung",
    "Fraunhofer Institute for Optronics, System Technologies and Image Exploitation",
    "Fraunhofer Institute for Optronics, Systems Engineering and Image Exploitation",
    "Fraunhofer IOSB",
    "FhG IOSB",
]

FRAUNHOFER_IML_SYNONYMS = [
    # Fraunhofer-Institut für Materialfluss und Logistik
    "Fraunhofer-Institut für Materialfluss und Logistik",
    "Fraunhofer-Institut fuer Materialfluss und Logistik",
